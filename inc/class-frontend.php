					...
					jQuery(document).ready(function($) {
						...
						var pluginOptions = {
							...
							imageEditorSettings: {
								...
								// MRR - Add feather masks folder locations
								featherMasks: <?php echo json_encode(fpd_get_files_from_uploads_by_type('fpd_feather_masks', array('svg')), JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT); ?>
								// MRR-END
							},
