<div>
	...
	<div class="fpd-image-editor-container">
		...
		<div class="fpd-image-editor-menu">
			...
			<!-- MRR - Add Feather Mask Tab to FPD Advanced Image Editor window -->
			<span data-id="feather-mask" data-defaulttext="Feather Mask">image_editor.feather_mask</span>
			<!-- MRR-END -->
		...
		<div class="fpd-tab-content">
			...
			<!-- MRR - FPD Advanced image editor feather-mask window contant -->
			<!-- FEATHER MASK -->
			<div data-id="feather-mask" class="fpd-content-feather-mask">
				<div class="fpd-feather-mask-selection"></div>
				<div class="fpd-feather-mask-tools">
					<span class="fpd-feather-mask-cancel fpd-btn fpd-dark"><span class="fpd-icon-close"></span></span>
					<span class="fpd-feather-mask-save fpd-btn"><span class="fpd-icon-done"></span></span>
				</div>
			</div>
			<!-- MRR-END -->
